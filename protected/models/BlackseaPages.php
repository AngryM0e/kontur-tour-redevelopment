 ...
 * @property integer $disp_links
 * @property integer $disp
 */
class BlackseaPages extends CActiveRecord
{
        public $disp;
	/**
	...
	public function rules()
	{
		...
		return array(
            ...
            array('links, disp_links','safe'),
			array('id,url, meta_title, title, description, keywords, text, sort_num, disp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
            ...
            'links' => 'Ссылки',
            'disp_links' => 'Скрыть/Показать ссылки',
		);
	}
	...
	public function search()
	{
        ...
        $criteria->compare('disp_links',$this->disp_links,true);
        $criteria->compare('disp',$this->disp,true);
