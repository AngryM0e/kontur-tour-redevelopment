...
<tr>
  <td></td><td><input type='submit'  style='font-size: 14pt;' value='Поиск'></td>
</tr>
</form>
<td></td><td>
  <form action='podbortur.php' method='get'>
<input type='submit' style='font-size: 14pt;' value='Вывести все туры'>
</form>
</td>
</table>
</form>
...
/*выбираем из таблицы информацию для вывода на экран*/
...
<center><font color=red size=3><b>Стоимость указана за номер без стоим. дополнительного места!</b></font></center>
	...
	if($line[kolvo]<=0) 
	{$line[kolvo]='<font color=red>Нет</font>'; }
