		...
		<tr>
			<td style="border-right:1px solid #000000" width="66%">
				...
				<h1 style="text-align: center;">
					ПРИЛОЖЕНИЕ&nbsp; К&nbsp; ДОГОВОРУ&nbsp;№<span style="text-decoration:underline">&nbsp;<?=$result['id_zakaz']?>&nbsp;</span></h1>
				<p>
					<strong>ТУР</strong>:&nbsp; <span style="text-decoration:underline">&nbsp;<?=$result['city']?>,
					 &nbsp;<?=$result['name1']?>&nbsp;</span></p>
				<p align="center">
				...
				<p>
					<strong>Продолжительность поездки:</strong> <strong><span style="text-decoration:underline">с 
						&laquo;&nbsp;<?=date("d", strtotime($result['data1']))?>&nbsp;&raquo;
						&nbsp;<?=$month[date("m", strtotime($result['data1']))]?>&nbsp;по
						&laquo;&nbsp;<?=date("d", strtotime($result['data2']))?>&nbsp;&raquo;
						&nbsp;<?=$month[date("m", strtotime($result['data2']))]?>&nbsp; 2024 г.</span></strong></p>
				<p>
				...
				<p>
					пункты пребывания <span style="text-decoration:underline">&nbsp;<?=$result['city']?>&nbsp;</span><br />
				...
				<p>
					номер <span style="text-decoration:underline">&nbsp;<?=$result['name2']?>&nbsp;</span>. Размещение <span style="text-decoration:underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$numbertur?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> питание _______________ </p>
				<p>
					виза <u>&nbsp;&nbsp;&nbsp; нет &nbsp;&nbsp;&nbsp;</u> страховка _______________________ трансфер <span style="text-decoration:underline">&nbsp;<?=$result['transfer']?>&nbsp;</span> </p>
				<p>
				...
				<p>
					...
					&laquo;&nbsp;<?=date("d", strtotime($result['data']))?>&nbsp;&raquo;
					&nbsp;<?=$month[date("m", strtotime($result['data']))]?>&nbsp;<?=date("Y", strtotime($result['data']))?> г.&nbsp;</span></p>
			...
			<td>
				...
				<p align="center" style="margin-left:14.2pt;">
					ПРИЛОЖЕНИЯ&nbsp; К&nbsp; ДОГОВОРУ<strong> №<span style="text-decoration:underline">&nbsp;<?=$result['id_zakaz']?>&nbsp;</span></strong><br />
					&nbsp;</p>
				...
				<p style="margin-left:14.2pt;">
					<span style="text-decoration:underline">с 
						...
						&nbsp;<?=$month[date("m", strtotime($result['data1']))]?>&nbsp;по
						&laquo;&nbsp;<?=date("d", strtotime($result['data2']))?>&nbsp;&raquo;
						&nbsp;<?=$month[date("m", strtotime($result['data2']))]?>&nbsp;</span>&nbsp; 2024 г.</p>
				<p style="margin-left:14.2pt;">
					&nbsp;</p>
				<p>
				...
				<p>
					...
					<br />
					<strong>&nbsp;&nbsp;&nbsp;&nbsp; Стоимость путевки:</strong>____________________</p>
				<p>
					<strong>_____________________________________________</strong></p>
				<p>
					<strong>_____________________________________________</strong></p>
				<p>
					сумма прописью<?echo $result['stoim']?> </p>
				<p style="margin-left:14.2pt;">
					<br />
				...
				<strong>Дата продажи: <span style="text-decoration:underline">
					&laquo;&nbsp;<?=date("d", strtotime($result['data']))?>&nbsp;&raquo;
					&nbsp;<?=$month[date("m", strtotime($result['data']))]?>&nbsp;2024 г.</span></strong></td>
		</tr>
	</tbody>
</table>
<p>
