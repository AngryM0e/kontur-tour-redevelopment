...
Количество:<input name='kolvo' size='3' type='text' value='$kolvo'><br><br>Стоимость:<input name='stoim' size='7' type='text' value='$stoim'><p>";
echo'<input type=submit value="Уточнить стоимость!" onClick="return window.confirm(\'Правильно ввели?\')"></form><br>';
mysql_close($link);
}
