...
Стоимость:<input name='stoim' size='10' type='text' value='$stoim'>";
echo'<p><input type=submit value="Уточнить стоимость!" onClick="return window.confirm(\'Правильно ввели?\')"></form><br>';
mysql_close($link);
}
?> 
