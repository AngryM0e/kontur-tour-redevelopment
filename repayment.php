...
echo"<tr><td>
<center>
<form action='repaymentgo.php' method='post'>
<b><font size='4'>Внесите оплату (введенная сумма будет добавлена к существующей), дробные числа набираются через точку</font></b><p>
<input type=hidden value='$id_zakaz' name='id_zakazpay'>
<input type=hidden value='$payment' name='addpay'>
Сумма: <input name='addedpay' size='10' type='text' value=''><p>";
echo'<input type=submit value="оплатить" onClick="return window.confirm(\'Правильно ввели?\')"></form><br>';
mysql_close($link);
}
